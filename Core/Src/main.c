...
void set_servo_angle1(uint16_t angle)
{
  ...
  // Check if angle is 180 degrees, then set it to 0
//  if (angle > 180) {
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : topLeft_Pin bottomLeft_Pin topRight_Pin bottomRight_Pin */
  GPIO_InitStruct.Pin = topLeft_Pin|bottomLeft_Pin|topRight_Pin|bottomRight_Pin;
  ...
  /*Configure GPIO pin : RMII_RXD1_Pin */
